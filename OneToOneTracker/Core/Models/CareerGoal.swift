...
extension CareerGoal {
    static let sample = CareerGoal(
        ...
        category: .technical,
        targetDate: Date().addingTimeInterval(86400 * 180), // 6 months
        status: .inProgress,
        priority: .primary,
    ...
    static let samples: [CareerGoal] = [
        CareerGoal(
            title: "Become a Senior Engineer",
            goalDescription: "Develop the skills and demonstrate the impact needed for promotion",
            category: .technical,
